...
# -*- coding: utf-8 -*-
# SS-GvM Monitoring + Multi-Parameter Simulation — Kimberley
# Author: M365 Copilot | Date: 2026-01-03
#
# Features:
#  - Fit SS-GvM to Baseline and Monitoring hot-day phases (Open-Meteo archive)
#  - Alerts for mu1 (primary phase), mu2 (secondary phase), concentrations (k1,k2), skew (eta), and skew orientation (nu)
#  - Density visualization (baseline vs monitoring)
#  - Multi-parameter Monte Carlo simulation for mu1, mu2, k1, k2, eta
#  - Probability curves and monthly summaries (P(Delta mu1 > theta_mu1) etc.)
...
# ---------------- UI ----------------
st.title("SS-GvM Monitoring + Simulation — Kimberley")
...
try:
    ...
    # Download CSVs
    # Quarterly percentiles (90/180/270/360)
